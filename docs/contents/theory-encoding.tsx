...
export default function Page() {
  return (
    <DocsPage>
      ...
      <Aside label="つながり">
        「なぜ英字1バイト・日本語3バイトで済むのか」という発想は、頻度に応じてビット長を変える符号化の考え方(「<Link href="/theory/probability">確率・統計と情報理論</Link>」のハフマン符号)とも通じます。HTTPでの文字コード宣言は「<Link href="/dev/frontend/web-basics">Web基礎</Link>」側の話題です。
      </Aside>
