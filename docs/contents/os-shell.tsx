    ...
    <DocsPage>
      <Hero>
        ...
        <Lead>
          ...
          この当たり前のやり取りを支えているのが<Term>シェル</Term>です。ユーザーが入力したコマンドを解釈し、カーネルに橋渡しして、結果を返す。半世紀以上かけて磨かれてきた「人とOSの対話の窓口」の歴史をたどります。いま手元のターミナルをどう使うかは<Link href="/dev/workspace">ターミナルとシェル</Link>で扱います。
        </Lead>
      </Hero>
