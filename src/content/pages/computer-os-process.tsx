...
export default function Page() {
  return (
    <DocsPage>
      ...
      <DiagramFrame
        slug="computer-os-process-segments"
        aspect="380 / 300"
        caption="プロセスのメモリ空間を5つのセグメントに分けた図。低位側からテキスト(命令・読み取り専用)、データ(初期値ありの変数)、BSS(初期値なしの変数)、ヒープ、スタックの順に並び、ヒープは上へ、スタックは下へと互いに向かって成長する。"
      />
      ...
      <DocsFooter href="/computer/os-process" />
    </DocsPage>
  );
}
