...
export default function Page() {
  return (
    <DocsPage>
      ...
      <p>「<Link href="/computer/hardware">PCハードウェアの基礎</Link>」の図で、CPUやメモリがマザーボードを介してつながっているのを見ました。あの配線の集まりがバスです。まずは「何を運んでいるのか」から見ていきます。</p>
      ...
      <DocsFooter href="/computer/io-bus" />
    </DocsPage>
  );
}
