...
export default function Page() {
  return (
    <DocsPage>
      ...
      <DiagramFrame
        slug="computer-memory-speed-hbm"
        aspect="640 / 240"
        caption="従来のGDDRとHBMの実装の違い。GDDRは基板の上にDRAMチップを横並びに置くため配線が長くなり帯域に限界がある。HBMはDRAMを縦に多層で積み上げ、TSVで直結するため帯域が桁違いに大きくなる。"
      />
      ...
      <DiagramFrame
        slug="computer-memory-speed-cycle"
        aspect="640 / 120"
        caption="「足りなさ」が繰り返す循環。余裕ができる→使い切る→足りなくなる→工夫する(新技術)と巡り、工夫がまた新しい余裕を生んで、その余裕がまた使い切られていく。"
      />
      <CardGrid>
        <Card>
      ...
      <DocsFooter href="/computer/memory-speed" />
    </DocsPage>
  );
}
