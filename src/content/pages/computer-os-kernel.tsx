...
export default function Page() {
  return (
    <DocsPage>
      ...
      <DiagramFrame
        slug="computer-os-kernel-layers"
        aspect="560 / 280"
        caption="コンピュータシステムの4層構造。第1層のハードウェア(CPU・メモリ・HDD/SSD・GPU)の上に、第2層のカーネル(ハードウェアを直接触れる唯一の存在であるハードウェア抽象化層)、第3層のシステムプログラム(シェル・エクスプローラー・設定などカーネル以外のOS)、第4層のアプリケーション(ブラウザ・ゲーム・オフィスソフト)が積み上がる。"
      />
      ...
      <DiagramFrame
        slug="computer-os-kernel-rings"
        aspect="360 / 300"
        caption="Intel CPUのリングレベル。同心円が4重になっており、中心のRing 0にカーネルが位置し、外側へRing 1・Ring 2と続き、最外周のRing 3で一般アプリが動作する。番号が小さい内側ほど特権が高い。"
      />
      ...
      <DocsFooter href="/computer/os-kernel" />
    </DocsPage>
  );
}
