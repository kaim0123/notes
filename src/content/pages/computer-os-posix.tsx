...
export default function Page() {
  return (
    <DocsPage>
      ...
      <DiagramFrame
        slug="computer-os-posix-family"
        aspect="640 / 260"
        caption="UNIX系OSの系譜。1969年にベル研究所で生まれたUNIXを源流に、認定を受けた商用UNIX(macOS・Solaris・AIX)、BSD(FreeBSD・OpenBSD)、UNIX系のLinux(Ubuntu・Fedoraなど)へ分かれる。POSIXは、その全員が従う最低限の共通ルールとして全体の土台に置かれている。"
      />
      ...
      <DocsFooter href="/computer/os-posix" />
    </DocsPage>
  );
}
