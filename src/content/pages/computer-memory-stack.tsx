...
export default function Page() {
  return (
    <DocsPage>
      ...
      <DiagramFrame
        slug="computer-memory-stack-frames"
        aspect="640 / 220"
        caption="関数呼び出しに伴うスタックフレームの増減。①mainだけが積まれた状態から、②funcAの呼び出しでその上にフレームが積まれ、③funcBの呼び出しでさらに積まれる。④終了時は逆順に片付いていく。RSPは常に積み上がった先頭のフレームを指す。"
      />
      ...
      <DocsFooter href="/computer/memory-stack" />
    </DocsPage>
  );
}
