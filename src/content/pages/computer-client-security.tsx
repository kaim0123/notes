...
export default function Page() {
  return (
    <DocsPage>
      ...
      <DiagramFrame
        slug="computer-client-security-layers"
        aspect="620 / 170"
        caption="端末を中心にした多層防御。中央に従業員の端末があり、その周りに脅威と対策の組が4つ並ぶ。左上が紛失・盗難に対するBitLocker、左下が遠隔管理のMDM、右上がマルウェアに対するEPPとEDR、右下が持出し・持込みに対するUSB制御。"
      />
      ...
      <DocsFooter href="/computer/client-security" />
    </DocsPage>
  );
}
