...
export default function Page() {
  return (
    <DocsPage>
      ...
      <DiagramFrame
        slug="computer-semiconductor-switch"
        aspect="560 / 220"
        caption="トランジスタをスイッチとして見た図。左の入口から右の出口へ電気の通り道があり、その途中にトランジスタが置かれている。下から伸びる背中(ゲート)に電気が来ている間だけ、入口から出口へ電気が通る。"
      />
      ...
      <DocsFooter href="/computer/semiconductor" />
    </DocsPage>
  );
}
